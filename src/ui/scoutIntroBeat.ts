...
const BEATS: readonly StoryBeat[] = [
  ...
  { who: 'npc', name: 'Remi', text: 'Um — hi! Hi. You\'re the manager. Of Pixel Perfect. The team. I just—' },
  ...
  { who: 'npc', name: 'Remi', text: 'No— oh no, no, no—' },
  ...
  { who: 'npc', name: 'Remi', text: 'Maybe? I really like spreadsheets. And, um. This game. A lot.' },
  { who: 'npc', name: 'Remi', text: 'I used to come here all the time — with my brother. He wanted to go pro. Then he left for college, and I didn\'t really want to come alone.' },
  { who: 'npc', name: 'Remi', text: 'I heard the café might close. And I just— I want to help. I don\'t want money, or a job, or anything. Here— take it.' },
  ...
  { who: 'npc', name: 'Remi', text: 'It\'s only MOSTLY complete!' },
  ...
  { who: 'you', text: 'Alright, Remi — what should we dig into first?' },
  {
    ...
    options: [
      { label: 'Their attack — how they hit sites.', set: { scoutFocus: 'attack' }, reply: [{ who: 'npc', name: 'Remi', text: 'Their entries and executes — got it. I\'ll have their tendencies mapped.' }] },
      { label: 'Their defense — how they hold.', set: { scoutFocus: 'defense' }, reply: [{ who: 'npc', name: 'Remi', text: 'Setups and rotations — on it. You\'ll know where they sit.' }] },
      { label: 'Their weak spot — how to game-plan them.', set: { scoutFocus: 'weakness' }, reply: [{ who: 'npc', name: 'Remi', text: 'Where they crack under pressure — I\'ll find the angle you exploit.' }] },
    ],
  },
  { who: 'npc', name: 'Remi', text: 'I\'ll have a full breakdown before your next match. This is the best day of my LIFE.' },
